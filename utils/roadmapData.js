export const roadmaps = [
  {
    id: "blind-75",
    title: "The Blind 75",
    description: "The 75 most essential LeetCode questions, curated by a Meta engineer. Master these and you're ready for almost any interview.",
    category: "DSA",
    topics: [
      {
      ...
      },
      {
        ...
        problems: [
          ...
          { title: "Construct Tree from Preorder and Inorder Traversal", slug: "construct-binary-tree-from-preorder-and-inorder-traversal", difficulty: "Medium" },
  ...
  },
  {
    ...
    description: "Master frontend system design and common machine coding rounds.",
    category: "Frontend",
    topics: [
      {
        title: "Basic Components",
        problems: [
          { title: "Build a Counter", slug: "counter-app", difficulty: "Easy" },
          { title: "Todo List", slug: "todo-list", difficulty: "Medium" },
        ]
      }
    ]
  }
